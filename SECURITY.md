...
Security fixes are made against the current supported release and active
development branches. Users should reproduce and report issues against the
latest available release whenever practical.
...
Use [GitHub Private Vulnerability Reporting](https://github.com/scottia/IMDb-Trakt-TMDb-Sync/security/advisories/new)
...
details until a private contact method is provided through the repository.
